...
const App = () => {
    ...
    let [password, setPassword] = useState<null | number>(null);   //密码
    let [code, setCode] = useState<null | number>(null);   //账号
            ...
            <div className='login_tocenter'>
                {/* <form> */}
                    ...
                    <div style={{ marginTop: 10, textAlign: 'center' }} >
                        <Button type='primary' onClick={submit_thing}>点击注册</Button>
                    </div>
